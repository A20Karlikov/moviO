...
class MovieDetailsFragment : Fragment(R.layout.fragment_movie_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bindingFillMovieDetails(movie, binding)
    }

    fun bindingFillMovieDetails(movieForFilling: Movie, binding: FragmentMovieDetailsBinding){
        binding.movieName.text = movieForFilling.name
        binding.moviePoster.setBackgroundResource(movieForFilling.poster)
        binding.movieYear.text = movieForFilling.year
        binding.movieGenre.text = movieForFilling.gerne
        binding.movieCast.text = movieForFilling.cast
        binding.overviewText.text = movieForFilling.overview
    }
